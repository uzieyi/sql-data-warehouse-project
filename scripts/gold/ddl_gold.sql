...
Script Purpose:
    ...
    The Gold layer represents the final dimensions and fact tables (Stat Schema) 
...
SELECT 
	...
	la.cntry AS Country,
	ci.cst_marital_status AS marital_name,
	CASE WHEN ci.cst_gndr ! = 'na' THEN ci.cst_gndr  -- CRM is the master for customer information 
